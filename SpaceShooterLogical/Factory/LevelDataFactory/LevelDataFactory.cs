        ...
        public void LoadingLeveldataByID(int id, SeanD seanD)
        {
            ...
            foreach (var body in levelData.things)
            {
                ...
                if (body is AICarrierShipInBody)
                {
                    ...
                    seanD.GetBodyMessages().Add(new BodyInitMessage(BodyMessageID.CarrierShip, ship));
                ...
                if (body is AISmallShipInBody)
                {
                    ...
                    seanD.GetBodyMessages().Add(new BodyInitMessage(BodyMessageID.SmallShip1, ship));
                ...
                if (body is PlayerInBody)
                {
                    ...
                    seanD.GetBodyMessages().Add(new BodyInitMessage(BodyMessageID.MainShip, ship));
                ...
                if (body is EnviromentInBody)
                {
                    ...
                    seanD.GetBodyMessages().Add(new BodyInitMessage(BodyMessageID.Enviroment, envir));

...
{
    public class EliteShipBAiComponent : AIComponentBase
    {
        ...
        public EliteShipBAiComponent(ILevelActorComponentBaseContainer level, IShipComponentBaseContainer container) : base(container)
        {
            this.level = level;
        ...
        public EliteShipBAiComponent(EliteShipBAiComponent clone, IShipComponentBaseContainer container) : base(clone, container)
        {
        ...
        {
            return new EliteShipBAiComponent(this, container as IShipComponentBaseContainer);
        }
                ...
                if (distanceinrange)
                {
                    ...
                    if (body.FowardToTarget(list[0].GetPosition(), 2) > 0.98f)
                    {
                        if (DateTime.Now.Ticks - lastfireframe > delyfireframe * 2)
                        {
                            ...
                            //攻击
                            container.GetFireControlinternalBase().FireAI(1);
